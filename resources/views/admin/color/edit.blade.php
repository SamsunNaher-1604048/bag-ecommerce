                ...
                <div class="row">
                    ...
                    <div class="col-sm-12 col-lg-6 col-md-6 mt-3">
                        <div class="form-group">
                            ...
                            <input type="color" class="form-control color" name="code"  value="{{$color->code}}" required>
                            @if($errors->has('code'))
                    ...
                    <div class="col-sm-12 col-lg-6 col-md-6 mt-3">
                        ...
                        <div class="toggle-switch">
                            <input type="checkbox" id="toggle" class="toggle-input" value="1"  name="status" {{$color->status == 1?'checked':''}}>
